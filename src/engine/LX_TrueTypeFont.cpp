...
/**
*
*   @fn LX_TrueTypeFont::LX_TrueTypeFont(SDL_Color *color)
*
...
/**
*
*   @fn LX_TrueTypeFont::LX_TrueTypeFont(std::string font_file, SDL_Color *color)
*
...
/**
*
*   @fn LX_TrueTypeFont::LX_TrueTypeFont(std::string font_file, SDL_Color *color, int size)
*
...
/**
*
*   @fn void LX_TrueTypeFont::init(std::string font_file, SDL_Color *color, int size)
*
...
/**
*   @fn LX_TrueTypeFont::~LX_TrueTypeFont()
*
...
/**
*   @fn int LX_TrueTypeFont::sizeOfText(std::string text, int *w, int *h)
*
...
*
*   @warning If the default font in LX_TrueTypeFont is NULL, then a segmentation fault will occur
*
*/
...
/**
*   @fn int LX_TrueTypeFont::sizeOfText(TTF_Font *ttf, std::string text, int *w, int *h)
*
...
*
*/
int LX_TrueTypeFont::sizeOfText(TTF_Font *ttf, std::string text, int *w, int *h)
{
...
/**
*
*   @fn SDL_Surface * LX_TrueTypeFont::draw_SolidText(std::string text)
*
...
/**
*
*   @fn SDL_Surface * LX_TrueTypeFont::draw_SolidText(std::string text, unsigned int size)
*
...
*
*/
SDL_Surface * LX_TrueTypeFont::draw_SolidText(std::string text, unsigned int size)
{
...
/**
*
*   @fn SDL_Surface * LX_TrueTypeFont::draw_ShadedText(std::string text, Uint8 r, Uint8 g, Uint8 b)
*
*   Create an UTF-8 encoded text in shaded mode
*
*   @param text the text you want to display
...
*
*/
SDL_Surface * LX_TrueTypeFont::draw_ShadedText(std::string text, Uint8 r, Uint8 g, Uint8 b)
{
...
*
*/
SDL_Surface * LX_TrueTypeFont::draw_ShadedText(std::string text, Uint8 r, Uint8 g, Uint8 b, unsigned int size)
{
...
/**
*
*   @fn SDL_Surface * LX_TrueTypeFont::draw_BlendedText(std::string text)
*
...
/**
*
*   @fn SDL_Surface * LX_TrueTypeFont::draw_BlendedText(std::string text, unsigned int size)
*
*   Render the UTF-8 encoded text in solid mode. The size has to be specified.
*
*   @param text the text you want to display
...
*
*/
SDL_Surface * LX_TrueTypeFont::draw_BlendedText(std::string text, unsigned int size)
{
...
/**
*   @fn SDL_Surface * LX_TrueTypeFont::drawText(LX_TTF_TypeText type, std::string text, Uint8 r, Uint8 g, Uint8 b, unsigned int size)
*
...
*
*/
SDL_Texture * LX_TrueTypeFont::drawTextToTexture(LX_TTF_TypeText type,std::string text, unsigned int size)
{
...
/**
*
*   @fn void LX_TrueTypeFont::setColor(SDL_Color *color)
*
...
*
*/
void LX_TrueTypeFont::setColor(SDL_Color *color)
{
    if( color != NULL )
    {
        font_color.r = color->r;
